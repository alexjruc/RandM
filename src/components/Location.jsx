        ...
        <section className="text-sm py-10 px-2 flex flex-col gap-12">
            ...
            >
                <input
                    ...
                    className="bg-transparent outline-none text-white border-[#8EFF8B]  border-2 p-2"
                    required
                />
                <button
                    type="submit"
                    className="bg-[#8EFF8B]/50 border-[#8EFF8B] border-2 flex items-center gap-1 px-2"
                >
            ...
            <div className="border-[#8EFF8B] font-medium text-white text-center max-w-[1000px] mx-auto border-2 flex flex-col justify-center items-center px-10 py-4 gap-4">
                <h3 className="text-[#8EFF8B] text-xl">
